...
from zigpy.zcl.clusters.general import Basic, OnOff, Ota, PowerConfiguration, Time, Identify, Groups, PollControl
...
class TuyaSmartRemote0041Button(CustomDevice):
    """Tuya 1-button remote device."""

    signature = {
        # SizePrefixedSimpleDescriptor(endpoint=1, profile=260, device_type=0, device_version=1, input_clusters=[0, 1, 3, 4, 20], output_clusters=[4, 6, 19])
        MODEL: "TS0041",
        ENDPOINTS: {
            1: {
                PROFILE_ID: zha.PROFILE_ID,
